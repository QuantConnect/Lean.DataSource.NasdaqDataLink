...
{
    [ObsoleteAttribute("QuandlBitfinexDownloaderProgram is obsolete. Use NasdaqBitfinexDownloaderProgram instead.", false)]
    public static class QuandlBitfinexDownloaderProgram
    {
        ...
        {
            NasdaqBitfinexDownloaderProgram.NasdaqBitfinexDownloader(fromDate, apiKey);
        }
    }
}
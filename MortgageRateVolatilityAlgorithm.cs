...
{
    ///<summary>
    /// This Alpha Model uses Wells Fargo 30-year Fixed Rate Mortgage data from NasdaqDataLink to
    ...
    public class MortgageRateVolatilityAlgorithm : QCAlgorithm
    {
        ...
        private class MortgageRateVolatilityAlphaModel : AlphaModel
        {
            ...
            {
                // Add NasdaqDataLink data for a Well's Fargo 30-year Fixed Rate mortgage
                _mortgageRate = algorithm.AddData<NasdaqMortgagePriceColumns>("WFC/PR_GOV_30YFIXEDVA_APR").Symbol;
        ...
        public class NasdaqMortgagePriceColumns : NasdaqDataLink
        {
            public NasdaqMortgagePriceColumns()

                // Rename the NasdaqDataLink object column to the data we want, which is the 'Value' column
